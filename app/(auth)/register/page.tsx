...
export default function RegisterPage() {
    ...
    // (the database trigger automatically creates the matching public.users profile)
    const { error: registerError } = await register(email, password, name, role as "buyer" | "vendor")
    ...
    // We need the new user's id — Supabase Auth just logged them in via signUp,
    // so we can fetch their session to get it.
    if (role === "vendor") {
    ...
    toast.success(`Welcome to MultiMart, ${name}!`)
